...
public class saveStory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        againButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent tofinal = new Intent(saveStory.this, configActivity.class);
                saveStory.this.startActivity(tofinal);
            }
        });
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                saveStory.this.startActivity(new Intent(saveStory.this, startActivity.class));
            }
        });
